...
So then I move to YouTube. I type `learn algorithmic trading` in the search bar, and I get a few courses. I spot that [freeCodeCamp](https://freecodecamp.org/), a brand I'm familiar with, has a couple of courses - an [older one](https://youtu.be/xfzGZB4HhEE?si=BqcTO1L7ete2Pcqx) that lasts 4 hours,
